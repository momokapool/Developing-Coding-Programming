...
namespace database_practice_lam_lai {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class employeeDataTable : global::System.Data.TypedTableBase<employeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public employeeRow AddemployeeRow(int Id, string name, int salary, string role) {
...
namespace database_practice_lam_lai.Database1DataSetTableAdapters {
    ...
    public partial class employeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[employee] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)) AND ((@IsNull_role = 1 AND [role] IS NULL) OR ([role] = @Original_role)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[employee] ([Id], [name], [salary], [role]) VALUES (@Id, @name," +
                " @salary, @role);\r\nSELECT Id, name, salary, role FROM employee WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[employee] SET [Id] = @Id, [name] = @name, [salary] = @salary, [role] = @role WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)) AND ((@IsNull_role = 1 AND [role] IS NULL) OR ([role] = @Original_role)));
SELECT Id, name, salary, role FROM employee WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::database_practice_lam_lai.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, salary, role FROM dbo.employee";
        ...
        public virtual int Delete(int Original_Id, string Original_name, global::System.Nullable<int> Original_salary, string Original_role) {
        ...
        public virtual int Insert(int Id, string name, global::System.Nullable<int> salary, string role) {
        ...
        public virtual int Update(int Id, string name, global::System.Nullable<int> salary, string role, int Original_Id, string Original_name, global::System.Nullable<int> Original_salary, string Original_role) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, global::System.Nullable<int> salary, string role, int Original_Id, string Original_name, global::System.Nullable<int> Original_salary, string Original_role) {
